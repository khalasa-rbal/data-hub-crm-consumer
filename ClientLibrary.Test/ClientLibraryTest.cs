...
{
    [TestFixture]
    internal class KclTest : IDisposable
    {
        ...
        {
            void runTest(IRecordProcessor rp)
            {
                _input.Position = 0;
        ...
        public void HappyCase()
        {
            ...
            TestRecordProcessor recordProcessor = new()
            {
        ...
        public void CheckpointErrorHandling()
        {
            ...
            void handler(string sequenceNumber, string errorMsg, Checkpointer checkpointer)
            {
